...
function ProcessParameters()
{
	...
	this.jpegrfactor = g.DefResize;
	this.jpegcfactor = g.DefCrop;
	this.pngresize = false;
	this.pngrfactor = g.DefResize;
	this.pngcfactor = g.DefCrop;
	this.psdresize = false;
	this.psdrfactor = g.DefResize;
	this.psdcfactor = g.DefCrop;
	this.tiffresize = false;
	this.tiffrfactor = g.DefResize;
	this.tiffcfactor = g.DefCrop;
	this.jpegq = 5;
